...
import { didSelectVisibilitySettngs } from '../../actions'
import Color from "../../Helper/Color";

class GroupVisibilitySettings extends Component {
      ...
      <Container style={{ backgroundColor: Color.WHITE }}>
        ...
        <Content style={styles.content}>
          <View style={{ backgroundColor: '#ddd' }}>
            <Title style={styles.title}>Visibility Settings</Title>
          </View>
          <FlatList
            data={data}
...
function bindAction(dispatch) {
  return {
    settingSelected: setting => dispatch(didSelectVisibilitySettngs(setting))
  };
}

const mapStateToProps = state => {
  return {
    selectedSettings: state.groupMembersReducer.visibility
  }
};

export default connect(mapStateToProps, bindAction)(GroupVisibilitySettings);
