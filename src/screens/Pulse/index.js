...
class Pulse extends Component {
  ...
  renderPatientDetails = () => {
    return (
      <View style={{ flexDirection: 'row', marginTop: 15, paddingHorizontal: 0, alignItems: 'center', backgroundColor: 'rgb(59,63,76)' }}>
  ...
  renderBloodSugar = () => {
    return (
      <View style={{ marginTop: 12, paddingHorizontal: 20, }}>
        ...
        <Dropdown
          rippleOpacity={0}
          data={oxygenLevelOptions}
          textColor={'#000'}
          baseColor={'#000'}
          value={this.state.selectedOxygenLevel}
          onChangeText={label => {
            this.setState({ selectedOxygenLevel: label });
          }}
          renderBase={() => {
            return (
              <View style={{
    ...
    return (
      <View style={{ marginTop: 15, paddingHorizontal: 20, }}>
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ marginLeft: 10, fontSize: 16 }}>bpm</Text>
        </View>
      </View>
    )
  }
