...
const surgeryList = [
  { name: 'Pacemaker', conductedOn: '7 May 2020', operatedBy: 'Nothing' },
  { name: 'Kidney Stone remover', conductedOn: '25 Aar 2020', operatedBy: 'Nothing' }
]
...
class SurgeryList extends Component {
  ...
  renderCenterHeader = () => {
    return (
      <Text style={styles.headerText}>{localizedStrings.surgeryList.headerName}</Text>
    )
  }

  renderRightHeader = () => {
    return (
      <TouchableOpacity style={{ marginRight: 8 }} onPress={() => this.props.navigation.navigate("AddSurguryprocedure")}>
      ...
      <View style={{ marginHorizontal: 20, flexDirection: 'row', paddingVertical: 10, alignItems: 'center' }}>
        <View style={{ flex: 1 }}>
          ...
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ fontSize: 16, color: Color.GREY, fontWeight: '300' }}>{localizedStrings.surgeryList.conductedOn}</Text>
            <Text style={{ fontSize: 16, color: Color.GREY, fontWeight: '600', marginLeft: 8 }}>{item.conductedOn}</Text>
          </View>
          <View style={{ flexDirection: 'row' }}>
            <Text style={{ fontSize: 16, color: Color.GREY, fontWeight: '300' }}>{localizedStrings.surgeryList.operatedBy}</Text>
            <Text style={{ fontSize: 16, color: Color.GREY, fontWeight: '600', marginLeft: 8 }}>{item.operatedBy}</Text>
          </View>
        </View>
